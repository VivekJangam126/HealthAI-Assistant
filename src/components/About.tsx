  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <section>
          <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Open Source Project</h3>
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:bg-gradient-to-r dark:from-gray-800 dark:to-gray-900 rounded-lg p-6">
            <p className="text-gray-600 dark:text-gray-400">
              This is an open-source project built by a community of developers passionate about creating innovative solutions in healthcare technology. We believe in building user-friendly applications that make a difference in people's lives.
            </p>
            <div className="flex flex-wrap gap-4 mt-4">
              <a
                href="https://github.com/VivekJangam126/HealthAI-Assistant"
                target="_blank"
